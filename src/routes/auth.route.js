...
import { register, loginPage, dashboard, changepwd, signup, signin, signout, initUserTable, deleteUserTable, verify_changepwd, quickchangepwd, verify_quick_changepwd } from '#controllers/auth.controller.js';
